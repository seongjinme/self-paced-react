import {
  categoryAsianImage,
  categoryChineseImage,
  categoryEtcImage,
  categoryJapaneseImage,
  categoryKoreanImage,
  categoryWesternImage,
} from "../../assets";
  ...
  return (
    <section className="restaurant-list-container">
      <ul className="restaurant-list">
        ...
        <li className="restaurant">
          <div className="restaurant__category">
            <img src={categoryEtcImage} alt="기타" className="category-icon" />
          </div>
          <div className="restaurant__info">
